MAIN = main
NAME = oucthesis
CLSFILES = $(NAME).cls oucextra.sty
BSTFILES = oucnumerical.bst oucauthoryear.bst oucbachelor.bst
...
# Build the standalone English user guide
doc-en : oucthesis_en.pdf

oucthesis_en.pdf : oucthesis_en.tex FORCE_MAKE
	$(LATEXMK) $<
...
zip : main doc
	...
	$(NAME).cls,$(NAME).pdf,figures,oucnumerical.bst,oucauthoryear.bst,\
	oucbachelor.bst,oucextra.sty,$(MAIN).tex,$(MAIN).pdf,chapters,bib,\
	.latexmkrc,Makefile}
	rm $(NAME)
