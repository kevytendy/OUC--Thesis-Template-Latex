\chapter{Mathematics and Formulae}

\section{Mathematical Symbols}

The template defines some upright mathematical symbols:
\begin{center}
\begin{tabular}{rl}
  \toprule
    Symbol                 & 命令 \\
  \midrule
    Euler's Number$\eu$     & \verb|\eu| \\
    plural units$\iu$ & \verb|\iu| \\
    diff$\diff$ & \verb|\diff| \\
    $\argmax$         & \verb|\argmax| \\
    $\argmin$         & \verb|\argmin| \\
  \bottomrule
